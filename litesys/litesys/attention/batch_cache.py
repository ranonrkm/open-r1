...
class BatchKVManager:
    ...
    def compute_attention(self, 
        ...
        if seq_len > 1:
            ...
            output =  attention_forward(query_states, self.k_cache[layer_idx], self.v_cache[layer_idx], batch_idx, self.kv_offset[layer_idx][batch_idx], attn_topk=self.attn_topk)
