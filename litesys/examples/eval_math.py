...
def worker(rank, world_size, args, shared_list):
    ...
    max_seq_len=args.max_len, max_batch_size=args.batch_size, top_p=0.95, temperature=0.6, use_chat_template=True, attn_local=args.local, attn_topk=args.topk, attn_nsample=args.nsample, attn_topk_block=args.topk_block)
...
def main():
    ...
    parser.add_argument('--local', type=int, default=0, help='Attn Local')
    parser.add_argument('--topk', type=int, default=0, help='Attn TopK')
    parser.add_argument('--nsample', type=int, default=0, help='Attn Nsample')
    parser.add_argument('--topk_block', type=int, default=0, help='Attn TopK Block')
